...
original papers. Our main reference for this chapter is \ocite{dsps-dualizable}.
...
\begin{theorem}\label{t:tens-rigid}
  ...
  $\calC^e$.
\end{theorem}
A proof can be found in \ocite{dsps-dualizable}*{Proposition 3.1.2}.
...
Warning: in \ocite{dsps-dualizable}, they use opposite convention!
...
Proof is given in \ocite{dsps-dualizable}*{Proposition 3.2.1}.
...
theorem is given in  \ocite{dsps-dualizable}*{Proposition 3.4.1}.
...
\end{theorem}
This is \ocite{dsps-dualizable}*{Proposition 3.4.3}.
...
\begin{remark}
  In \ocite{dsps-dualizable} this theorem is formulated slightly differently:
...
semisimple; see \ocite{dsps-dualizable}*{Proposition 3.4.10}.
...
\ocite{dsps-dualizable} has a detailed description of this action in terms of
framing.
...
\begin{remark}\label{r:radford}
  ...
  \ocite{etingof-fusion}*{Corollary 7.19.3}. It is closely related with
  ...
  \ocite{etingof-fusion}*{Section 7.19} for discussion of this.
\end{remark}
...
\begin{example}\label{x:sl2-pivotal}
  ...
  definition of the Kauffman bracket invariant of links (see \ocite{kauffman}),
...
dimensions, can be found in \ocite{etingof-fusion}*{Section 4.7}.
...
\begin{remark}
  ...
  \reref{r:radford}, see \ocite{dsps-dualizable}*{Proposition 3.5.4}.
\end{remark}
...
\begin{conjecture}
  ...
  categories.
\end{conjecture}
Reference: \ocite{dsps-dualizable}*{Conjecture 3.5.10}.
...
\ocite{lurie-cobordism} by Jacob Lurie; a short exposition can also be
found in \ocite{freed-cobordism}.
...
%consistency conditions; one can find all details in \ocite{hesse}.
...
\ocite{schommer-pries-category}*{Section 16})
...
(this is the point of view taken in \ocite{schommer-pries-category}).
...
\begin{remark}\label{r:Ainfty}
  ...
  \ocite{boardman-vogt}*{Propositions 1.15, 1.16}.
\end{remark}


For $n=2$, one can unpack this definition and write all the required data
and consistency relations explicitly; see \ocite{hesse}*{Remark 2.16}.
For $n=3$, see \ocite{schommer-pries-category}.

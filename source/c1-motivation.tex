...
\ocite{peskin-schroeder} or the recent book \ocite{etingof-qft},
...
theory\footnote{This is a minor simplification: Chern--Simons theory is not 
  ...
  more detail in \chref{c:321}} (see \ocite{witten-jones}), in which the 
spacetime $M$ must be
...
We will provide a more precise definition, due to Atiyah \ocite{atiyah}, later
(see \deref{d:tqft}).

...
the reader to \ocite{rourke} for an overview of PL topology; another useful
reference is Lurie's lecture notes \ocite{lurie-PL}.
...
\begin{theorem}\label{t:triangulation1}
  ...
  \item
   ...
   \end{enumerate}
\end{theorem}
We refer the reader to \ocite{rourke}*{Theorem 2.11, Addendum 2.12} for
the proof.
...
reader to \ocite{rourke} for details.
...
\end{theorem}
We refer the reader to \ocite{milnor-review} and \ocite{lurie-PL}*{Lecture 23}
...
language, that of microbundles (see \ocite{lurie-PL}*{Lecture 10}). In fact,
...
\ocite{pachner}; an exposition can be found in \ocite{lickorish}. They can be
...
general cell decompositions, following \ocite{PLCW}.
...
\end{theorem}
A proof of this fact can be found in \ocite{PLCW}.

...
TQFT, following the work of Atiyah (see \ocite{atiyah}). To do that, we first
...
\end{theorem}
For a proof, see \ocite{kock}*{Theorem 1.3.12}.
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \begin{scope}[xshift=11cm]
      ...
      \node[left] at ($(45.center)+(+5.50,-1.50)$) {$\del M$};
      \node[below] at ($(45.center)+(0.50,-4.00)$) {$M_{\text{cut}}$};

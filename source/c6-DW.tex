...
\ocite{freed-quinn}, \ocite{teleman-five-lectures}.
...
this lemma as follows: for connected $M$, the groupoid $\tBun_G$
...
\ocite{baez-dolan-finite-sets}, or the blog post \ocite{baez-counting} by John Baez. 
In particular, we can count how many finite sets
...
for $g\ge 1$, we  we get the following identity

<h2 id="s:abelian-cats" class="tex-section"><span data-tag="0003">1.2</span> Abelian categories</h2>
<p>
...
<article class="env-example" id="">
  <p><a class="environment-identifier" href="/tag/">Example <span data-tag="">1.2.1</span>.</a>Below are some examples of $\mathbf{k}$-linear abelian categories. </p>
  <p><ol>
  <li><p>
...
<p>
 (see [etingof-fusion]*Section 1.8). 
</p>
<p>
...
<p>
<article class="env-lemma" id="0005">
  <p><a class="environment-identifier" href="/tag/0005">Lemma <span data-tag="0005">1.2.1</span>.</a> Let $\mathcal{A}$ be a locally finite $\mathbf{k}$-linear category. </p>
  <p><ol>
  <li><p>
...
</article> As with the usual Schur's lemma, the proof is immediate from the fact that the only finite-dimensional division algebra over an algebraically closed field $\mathbf{k}$ is $\mathbf{k}$ itself (see, e.g., [pierce]*Lemma 3.5). 
</p>

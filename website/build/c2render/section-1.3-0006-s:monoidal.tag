<h2 id="s:monoidal" class="tex-section"><span data-tag="0006">1.3</span> Monoidal categories</h2>
<p>
 One of the most important notions is the notion of a monoidal category, which informally is described as a category with an associative operation; the model example is the category of vector spaces with the operation of tensor product. In this section, we review this notion; as before, we refer the reader to [etingof-fusion]*Chapter 2; [leinster]*Section 1.2 for a more in-depth discussion. 
</p>
<p>
...
<p>
<article class="env-theorem" id="0007">
  <p><a class="environment-identifier" href="/tag/0007">Theorem <span data-tag="0007">1.3.1</span>.</a> Let $M$ be a monoid and $a_1, \dots , a_ n\in M$. Consider all possible expressions obtained by writing $a_1, \dots , a_ n$ (in this order), then inserting some copies of $1$ and then putting parentheses so that multiplications are just binary products, e.g., $(a_1 \cdot 1) \cdot (1 \cdot a_2) $. Then all of them are equal: if $X_1, X_2$ are two such expressions (with the same $a_1, \dots , a_ n$), then $X_1=X_2$. </p>
...
<div class="centered"> <img class="includegraphics" src="/static/figures/fig01.svg" /> &#8195;&#8195;<img class="includegraphics" src="/static/figures/fig02.svg" /> </div>
<p>
...
<p>
One can try to mimic the definition above. <article class="env-definition" id="0008">
  <p><a class="environment-identifier" href="/tag/0008">Definition <span data-tag="0008">1.3.1</span>.</a> A <em>strict monoidal category</em> is a category $\mathcal{C}$ together with a functor $\otimes \colon \mathcal{C}\times \mathcal{C}\to \mathcal{C}$ and a unit object $\mathbf{1}\in \mathcal{C}$ such that </p>
  <div class="equation">
...
<p>
The proper way is to require the existence of a distinguished (canonical) isomorphism which should be made part of the structure. Moreover, these “canonical” isomorphisms should themselves satisfy some compatibility conditions, as suggested by Convention&#160;<a href="/tag/0002" data-tag="0002">1.1.1</a>. 
</p>
<p>
...
<article class="env-example" id="">
  <p><a class="environment-identifier" href="/tag/">Example <span data-tag="">1.3.1</span>.</a>The following are examples of monoidal categories. </p>
  <p><ol>
  <li><p>
...
<p>
<article class="env-example" id="000A">
  <p><a class="environment-identifier" href="/tag/000A">Example <span data-tag="000A">1.3.2</span>.</a> Let $G$ be a group. Define the category $\mathbf{Vec}_ G$ of <em>$G$-graded vector spaces</em> as the category whose objects are finite-dimensional vector spaces $V$ together with decomposition </p>
  <div class="equation">
...
<p>
<article class="env-theorem" id="000B">
      
  <p><a class="environment-identifier" href="/tag/000B">Theorem <span data-tag="000B">1.3.2</span> <span class="named">(Mac Lane's coherence theorem)</span>.</a>Let $\mathcal{C}$ be a monoidal category. Let $F_1, F_2\colon \mathcal{C}^ n\to \mathcal{C}$ be two functors obtained by compositions of tensor product functor $\otimes $ and functors $X\mapsto X\otimes \mathbf{1}$, $X\mapsto \mathbf{1}\otimes X$, e.g., </p>
  <div class="equation">
...
<p>
<article class="env-example" id="">
  <p><a class="environment-identifier" href="/tag/">Example <span data-tag="">1.3.3</span>.</a>Consider the category of representations of a group $G$. Then the forgetful functor from this category to the category of vector spaces is a monoidal functor. More generally, given a subgroup $H\subset G$, the restriction functor $\operatorname{Res}^ G_ H\colon \operatorname{Rep}G\to \operatorname{Rep}H$ has an obvious monoidal structure. </p>
</article> <article class="env-example" id="">
  <p><a class="environment-identifier" href="/tag/">Example <span data-tag="">1.3.4</span>.</a>If $G$ is a connected, simply-connected Lie group, then the category of finite-dimensional representations of $G$ is equivalent, as a monoidal category, to the category of finite-dimensional representations of its Lie algebra $\mathfrak {g}$. </p>
</article> 
</p>
<p>
<article class="env-example" id="000F">
  <p><a class="environment-identifier" href="/tag/000F">Example <span data-tag="000F">1.3.5</span>.</a> Recall the category of $G$-graded vector spaces $\mathbf{Vec}_ G$ defined in . This category has a generalization. Namely, let $\omega \colon G\times G\times G\to \mathbf{k}^\times $ be a 3-cocycle, i.e., a function satisfying the condition </p>
  <div class="equation">
...
</article> <article class="env-exercise" id="">
  <p><a class="environment-identifier" href="/tag/">Exercise <span data-tag="">1.3.2</span>.</a>Let $\omega \colon G\times G\times G\to \mathbf{k}^\times $ be a 3-cocycle. Assume that $\omega $ is a coboundary, i.e., there exists a function $\beta \colon G\times G\to \mathbf{k}^\times $ such that $\omega =d\beta $, where the coboundary operator $d$ is given by </p>
  <div class="equation">
  ...
  <p>More generally, categories $\mathbf{Vec}_ G^\omega $ and $\mathbf{Vec}_ G^{\omega '}$ are equivalent, with the equivalence preserving the $G$-graded dimension, if and only if $\omega '=\omega \cdot d\beta $ for some $\beta \colon G\times G\to \mathbf{k}^\times $ (see [etingof-fusion]*Section 2.6). </p>
</article> 
</p>
<p>
We can restate Mac Lane's coherence theorem as follows. <article class="env-theorem" id="000G">
  <p><a class="environment-identifier" href="/tag/000G">Theorem <span data-tag="000G">1.3.3</span>.</a> Any monoidal category is monoidally equivalent to a strict monoidal category. </p>
...
<p>
<article class="env-convention" id="000H">
  <p><a class="environment-identifier" href="/tag/000H">Convention <span data-tag="000H">1.3.1</span>.</a> We will frequently use graphical presentation of morphisms in a monoidal category, representing a morphism $\varphi \colon A_1\otimes \dots \otimes A_ k\to B_1\otimes \dots \otimes B_ m$ by a box with $k$ inputs at the top and $m$ outputs at the bottom: </p>
  <p><figure class="figure">
  <div class="centered"><img class="includegraphics" src="/static/figures/fig05.svg" /> <figcaption class="figcaption">Figure 1.1. Graphical notation for a morphism in a monoidal category.</figcaption>  </div>

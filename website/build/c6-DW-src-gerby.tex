...
\cite{freed-quinn} and \cite{teleman-five-lectures}.
...
discussion of this, see \cite{baez-dolan-finite-sets}, or the blog post
\cite{baez-counting} by John Baez. In particular, we can count how many finite
sets there are --- try doing this yourself!


Similar ideas can also be used, e.g., to define the Euler characteristic of
an orbifold (see \cite[Section 2.4]{caramello}). (Note that there are several
...
unit is given by \includegraphics{figures/c6-eqfig01.svg}; since every bundle on a disk is trivial, and

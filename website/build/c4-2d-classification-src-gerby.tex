...
\begin{equation}\label{e:2d-assoc-prelim}\includegraphics{figures/c4-fig02.svg}\end{equation}
...
\begin{equation}\label{e:frobenius-data}\includegraphics{figures/c4-eqfig01.svg}\end{equation}
...
\begin{equation}\label{e:m-symmetric}\includegraphics{figures/c4-fig13.svg}\end{equation}
...
following two types:
\begin{center}\includegraphics{figures/c4-eqfig02.svg}\end{center}
...
\begin{equation}\label{e:S-local}\includegraphics{figures/c4-fig14.svg}\end{equation}
...
\begin{center}\includegraphics{figures/c4-eqfig03.svg}\end{center}

In this case, one easily sees that the corresponding Cerf move is given by
\begin{center}\includegraphics{figures/c4-eqfig04.svg}\end{center}
...
\begin{center}\includegraphics{figures/c4-eqfig05.svg}\end{center}

Similarly, graph $B$ gives the following Cerf move:
\begin{center}\includegraphics{figures/c4-eqfig06.svg}\end{center}
...
\begin{center}\includegraphics{figures/c4-eqfig07.svg}\end{center}
...
\begin{center}\includegraphics{figures/c4-eqfig08.svg}\end{center}

...
\cite[Section 3.2]{dijkgraaf-thesis}), even though a mathematically rigorous
...
There are two approaches. One, used in  \cite{abrams} and \cite{kock},
...
It is presented in \cite{moore-segal} and \cite[Lecture~23]{freed-bordism},

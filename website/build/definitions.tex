...
%\newcommand{\conref}[1]{\hyperref[#1]{Convention~{\rm\ref*{#1}}}}
...
\newcommand{\figscale}[2] 						%  used in figures for proof of 
{\raisebox{-0.5\height}%							%  invariance of TV in chapter 19
	{\includegraphics[scale=#1]{#2}}}
\newcommand{\xxto}{\xrightarrow}            % long arrow, used in chapter 19
\newcommand{\DD}{\dim(\calC)}      % dimension of category, use in chapter 19
\newcommand{\ccc}[1]{\underset{\scriptstyle #1}{\bullet}} %used in chapter 19

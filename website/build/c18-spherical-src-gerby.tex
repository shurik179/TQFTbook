...
\cite{joyal-street}, \cite{joyal-street2} and by Reshetikhin and Turaev
\cite{reshetikhin-turaev}. Our exposition follows the recent book
\cite[Chapter 2]{turaev-virelizier}, which provides the cleanest exposition
...
Let $\calC$ be a pivotal category. Following \cite{turaev-virelizier}, we
...
\begin{figure}[h]
  \centering
  \includegraphics{figures/c18-fig01.svg}
...
\begin{figure}[ht]
  \centering
  \includegraphics{figures/c18-fig02.svg}
...
\begin{figure}[ht]
  ...
  \includegraphics{figures/c18-fig03.svg}
\qquad\qquad
  \includegraphics{figures/c18-fig04.svg}
...
\end{theorem}
\begin{figure}[ht]
  \includegraphics{figures/c18-fig05.svg}
...
This theorem is a reformulation of \cite[Theorem 2.6]{turaev-virelizier}; we
...
\begin{remark}
  ...
  \cite[Corollary 4.7.13]{etingof-fusion}).
\end{remark}
...
\begin{remark}
  ...
  (\cite[Section 7.21]{etingof-fusion}); thus, $\dim \calC$ is well-defined
...
$\kk$. We refer the reader to \cite[Theorem 7.21.12]{etingof-fusion} for the
...
\end{lemma}
\begin{equation}\label{e:cyclic2}\includegraphics{figures/c18-eqfig01.svg}\end{equation}
...
\begin{definition}\label{d:colored-graph}
...
\begin{figure} [ht]
\centering
  \includegraphics{figures/c18-fig06.svg}
...
literature under the name ``string-nets'', see \cite{levin-wen}.


The following theorem is a modification of \thref{t:graphical-calculus1}; we
give it here in the form written down in \cite{kirillov-stringnet}.
...
\begin{figure}[ht]
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \includegraphics{figures/c18-fig07.svg}
  %%%%%%%%
  $=$
  %%%%%%%%
  \includegraphics{figures/c18-fig08.svg}
  %%%%%%%%%
  \\
  %%%%%%%%%
  \includegraphics{figures/c18-fig09.svg}
  %%%%%%%%%%%
  $=$
  %%%%%%%%%%%
  \includegraphics{figures/c18-fig10.svg}
  %%%%%%%
  \qquad $k\ge 0$\\
  %%%%%%%
  \includegraphics{figures/c18-fig11.svg}
  %%%%%%%%
  $=$
  %%%%%%%%
  \includegraphics{figures/c18-fig12.svg}
  %%%%%%%%%%%%%%%%%%%%%%%%%%
...
\cite{kirillov-stringnet}. We only give here one of them.
...
\begin{center}\includegraphics{figures/c18-eqfig08.svg}\end{center}

\leref{l:colored-spherical} was first proved in \cite{barrett}; in fact, this
...
\begin{convention}\label{c:summation_convention}
  ...
  \begin{equation}\label{e:summation-convention}\includegraphics{figures/c18-eqfig02.svg}\end{equation}
...
\begin{convention}
  ...
  \begin{equation}\label{e:regular-color}\includegraphics{figures/c18-eqfig03.svg}\end{equation}
\end{convention}
...
\begin{lemma}\label{l:colored-graphs}
  ...
  \begin{align}\includegraphics{figures/c18-eqfig04.svg}\end{align}
\end{lemma}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{remark}
  ...
  \cite[Example 7.9.14]{etingof-fusion}, where it is shown that $E\simeq
...
\begin{proof}
  ...
  \begin{equation}\label{e:gamma}\includegraphics{figures/c18-eqfig05.svg}\end{equation}
  We refer the reader to \cite{balsam-kirillov} for the proof that so defined
  $\ga$ satisfies $\ga_{A\otimes B}=\ga_A\circ \ga_B$;
  another proof of centrality of $E$ is given in
  \cite[Proposition 7.18.5]{etingof-fusion}.
...
follows \cite[Section 7.13]{etingof-fusion}.
\begin{definition}\label{d:drinfeld-center}
  ...
  \begin{itemize}
    ...
    \begin{enumerate}
      ...
      \begin{equation}\label{e:hexagon-drinfeld}\includegraphics{figures/c18-fig13.svg}\end{equation}
...
non-trivial. We refer the reader to \cite[Section 7.14]{etingof-fusion} for
details.
...
\cite[Section 7.13]{etingof-fusion}.
...
in  \cite[Proposition 7.13.8]{etingof-fusion}.
...
\begin{theorem}\label{t:drinfeld-dim}
  ...
  $$
\end{theorem}
See \cite[Proposition 9.3.4]{etingof-fusion}.
...
\begin{figure}[ht]
  \includegraphics{figures/c18-fig14.svg}
...
\begin{exercise}\label{ec:drinfeld-hexagon}
  ...
  \begin{center}\includegraphics{figures/c18-eqfig09.svg}\end{center}
\end{exercise}
...
\begin{exercise}\label{ec:drinfeld-projector}
  ...
  graph below:
  \begin{equation}\includegraphics{figures/c18-eqfig06.svg}\end{equation}
...
\begin{theorem}\label{t:drinfeld-induction}
  ...
  $$
  with $\ga$ given by:
  \begin{equation}\label{e:gamma2}\includegraphics{figures/c18-eqfig07.svg}\end{equation}
  \textup{(}compare with \eqref{e:gamma}\textup{)}.
\end{theorem}
We refer the reader to \cite[Theorem 2.3]{balsam-kirillov} for the proof.
...
\cite{fuchs-schaumann-schweigert-trace}; other references for the material of
this section include \cite{greenough} (probably one of the earliest references
on this topic) and \cite[Section 5]{benzvi-francis-nadler} (in the context
of $\infty$-categories).
...
\end{theorem}
  ...
  \cite[Theorem 3.3]{fuchs-schaumann-schweigert-trace}.

...
<article class="env-example" id="007T">
  ...
  <p> where $R$ is the regular representation (note the difference in normalization with (<a href="/tag/00EP" data-tag="00EP">6.2.10</a>)). </p>
  ...
  <p>In this case, we see that under identification $Z_ A(S^1)\simeq z(\mathbf{k}[G])$, the counit becomes $\tilde\varepsilon (z)=\frac{1}{|G|^2}\operatorname{tr}_ R(z)$ (note normalization!) which matches (<a href="/tag/00EP" data-tag="00EP">6.2.10</a>). Thus, the corresponding non-extended TQFT is the Dijkgraaf–Witten TQFT discussed in Chapter&#160;<a href="/tag/003K" data-tag="003K">6</a>. </p>
</article> 
</p>
<p>
<br /> 

...
<p>
Balsam and Kirillov's state-sum construction 3-2-1 extends the Turaev-Viro theory. It's natural to ask if they could have fully extended it to a 3-2-1-0 TQFT. In principle, this is doable. But this requires the full complexity of a weak 3 category. In particular, all the equivalences between ( compositions of ) 1-morphisms should hold upto 2-morphisms, and ( compositions of ) 2-morphisms should hold upto 3-morphisms. This leads to a very complicated web of coherence relations. The extension to 0 dimensional manifolds requires a more workable definition of an ($\infty $,3) category. 
</p>

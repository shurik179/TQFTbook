...
<p>
There are two approaches. One, used in <span class="cite">[<a href="/bibliography/abrams">Abr1996</a>]</span> and <span class="cite">[<a href="/bibliography/kock">Koc2004</a>]</span>, uses the classification of surfaces; using it, one shows that the relations we have are enough to bring any composition of generators to some canonical form. This approach does not require much beyond the classification of surfaces, but it does not generalize to higher dimensions. 
</p>
<p>
There is, however, an alternative approach, based on Morse and Cerf theory. It is presented in <span class="cite">[<a href="/bibliography/moore-segal">MS</a>]</span> and <span class="cite">[<a href="/bibliography/freed-bordism">Fre2012</a>, <span class="postnote">Lecture&#160;23</span>]</span>, the latter of which our exposition follows. One can also find more details in the unpublished paper <span class="cite">[<a href="/bibliography/gay-wehrheim-woodward">GWW2012</a>]</span>. 
</p>

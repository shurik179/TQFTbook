<h2 id="s:symmetric-monoidal" class="tex-section"><span data-tag="000Y">2.4</span> Symmetric monoidal categories</h2>
<p>
...
<div class="equation" id="00EX">
    ...
    <div class="centered"><img class="includegraphics" src="/static/figures/c2-fig07.svg"></div>
</div>
<p>
<article class="env-example" id="0010">
...
<p>
<article class="env-theorem" id="0011">

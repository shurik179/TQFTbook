...
<article class="env-example" id="00BZ">
  <p><a class="environment-identifier" href="/tag/00BZ">Example <span data-tag="00BZ">17.3.2</span>.</a> Let $\mathcal{C}$ be the category of finite-dimensional representations of Lie algebra $\mathfrak {sl}(2,\mathbb {C})$. Define the pivotal structure by </p>
  <div class="equation">

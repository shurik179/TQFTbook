...
<article class="env-example" id="002D">
  <p><a class="environment-identifier" href="/tag/002D">Example <span data-tag="002D">4.2.2</span>.</a> Consider the family of functions $f_ s(x)=x^2-x^4+sx$ on $\mathbb {R}$. Then for values of $s$ close to 0, $f_ s$ has three critical points, all of them non-degenerate: local minimum at $p_0$ close to 0, and local maxima at points $p_1&lt;0$, $p_2&gt;0$. </p>

...
<article class="env-example" id="002B">
  ...
  <p>Then for $s&lt;0$, the function is excellent with two critical points of indices $0$ and $1$ respectively; for $s&gt;0$, it is also excellent, with no critical points; and for $s=0$, $f_0(x)=x^3$ is not a Morse function: zero is a degenerate critical point. Thus, in this case, $f_ s$, considered as a path in the function space, connects two excellent Morse functions but goes through a non-Morse function $f_0=x^3$. This path describes the annihilation of a pair of critical points (or, going in the opposite direction, the birth of a pair of critical points). </p>
  <p><figure class="figure">
  <div class="centered"><img class="includegraphics" src="/static/figures/c4-fig07.svg" /> &#8195;&#8195;<img class="includegraphics" src="/static/figures/c4-fig08.svg" /> &#8195;&#8195;<img class="includegraphics" src="/static/figures/c4-fig09.svg" /> <figcaption class="figcaption">Figure 4.2.1. Birth–death of critical points in the family $f_ s=x^3+sx$.</figcaption>  </div>
...
<article class="env-example" id="002D">
  <p><a class="environment-identifier" href="/tag/002D">Example <span data-tag="002D">4.2.2</span>.</a> Consider the family of functions $f_ s(x)=2x^2-x^4+sx$ on $\mathbb {R}$. Then for values of $s$ close to 0, $f_ s$ has three critical points, all of them non-degenerate: a local minimum at $p_0$ close to 0, and local maxima at points $p_1&lt;0$ and $p_2&gt;0$, with critical values $c_1=f_ s(p_1)$, $c_2=f_ s(p_2)$. </p>
...
<p>
(Note that the name “good” is not standard.) 
</p>
<p>

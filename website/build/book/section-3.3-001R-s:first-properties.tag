<h2 id="s:first-properties" class="tex-section"><span data-tag="001R">3.3</span> First properties of TQFTs</h2>
...
<article class="env-theorem" id="001S">
  <p><a class="environment-identifier" href="/tag/001S">Theorem <span data-tag="001S">3.3.1</span>.</a> Let $Z\colon \mathbf{Cob}_ n\to \mathcal{C}$ be an $n$-dimensional TQFT with values in a symmetric monoidal category $\mathcal{C}$. Then for any closed $(n-1)$-dimensional manifold $N$, $Z(N)\in \mathcal{C}$ is rigid, and $Z(\overline{N})$ is a dual of $Z(N)$. </p>
...
<article class="env-exercise" id="001T">
  <p><a class="environment-identifier" href="/tag/001T">Exercise <span data-tag="001T">3.3.1</span>.</a> Let $Z$ be an $n$-dimensional TQFT with values in $\mathbf{Vec}$. Prove that then $Z(N\times S^1)=\dim Z(N)$ for any closed $(n-1)$-dimensional manifold $N$. </p>
</article> 
</p>
<p>
...
<div class="equation" id="001U">
    <span class="equation-label"><a href="/tag/001U" data-tag="001U">3.3.1</a></span>
...
As an immediate corollary, we get the following theorem. <article class="env-theorem" id="001W">
  ...
  <p><ol>
  <li><p>
For any orientation-preserving diffeomorphism $\varphi \colon N_0\to N_1$, define $Z(\varphi )\colon Z(N_0)\to Z(N_1)$ by $Z(\varphi )=Z(C_\varphi )$. Then $Z(\varphi _2\varphi _1)= Z(\varphi _2)\circ Z(\varphi _1)$. 
</p>
</li><li><p>
If $\varphi ,\varphi '$ are isotopic, then $Z(\varphi )=Z(\varphi ')$. 
</p>
</li>
</ol></p>
</article> <br /> 

...
\begin{definition}\index{2-cobordism}
...
\begin{center}
\includegraphics{figures/c10-fig01.svg}
\end{center}
...
\begin{center}\includegraphics{figures/c10-eqfig04.svg}\end{center}
...
\begin{center}\includegraphics{figures/c10-eqfig05.svg}\end{center}
subject to the relations shown in \firef{f:bord2-relations}.
\end{theorem}

\begin{figure}[ht]
  \centering
  \includegraphics{figures/c10-fig02.svg}
...
\begin{figure}[ht]
  \includegraphics{figures/c10-fig03.svg}
...
\begin{equation}\label{e:zigzag-zazb}\includegraphics{figures/c10-eqfig01.svg}\end{equation}
...
\begin{equation}\label{e:adj-plus}\includegraphics{figures/c10-eqfig02.svg}\end{equation}
...
\begin{equation}\label{e:adj-minus}\includegraphics{figures/c10-eqfig03.svg}\end{equation}
...
\begin{enumerate}
  ...
  2-morphisms
  \begin{center}\includegraphics{figures/c10-eqfig06.svg}\end{center}
...
with counit
\begin{center}\includegraphics{figures/c10-eqfig07.svg}\end{center}
In this case, as discussed in the proof of \thref{t:adjunction-frob}, the
operator \includegraphics{figures/c10-eqfig11.svg} is given by
\begin{center}\includegraphics{figures/c10-eqfig08.svg}\end{center}
...
shown below.
\begin{center}
  \includegraphics{figures/c10-fig04.svg}
\end{center}



Similarly,
\begin{center}\includegraphics{figures/c10-eqfig09.svg}\end{center}
...
\begin{theorem}\label{t:ext-tqft-frob3}
  ...
  $\eps$, such that
  \begin{center}\includegraphics{figures/c10-eqfig10.svg}\end{center}
   where $x_i, x^i$ are dual bases in $A$ with respect to the Frobenius pairing,

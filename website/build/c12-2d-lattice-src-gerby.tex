...
\begin{center}\includegraphics{figures/c12-fig01.svg}\end{center}
...
\begin{proof}
  ...
  \begin{center}\includegraphics{figures/c12-fig03.svg}\end{center}
...
\begin{example}\label{x:lattice-S2}
  ...
  \begin{center}\includegraphics{figures/c12-eqfig01.svg}\end{center}
...
\begin{exercise}\label{ec:lattice-pants}
  Show that \includegraphics{figures/c12-eqfig02.svg}, where $V=Z_A(S^1)=A/[A,A]$,
  is given by
  $$

...
\cite{peskin-schroeder} or a recent book \cite{etingof-qft},
...
theory (see \cite{witten-jones}), in which the spacetime $M$ must be
...
We will provide a more precise definition, due to Atiyah \cite{atiyah}, later (see \deref{d:tqft}).

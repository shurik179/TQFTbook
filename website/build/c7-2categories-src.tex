...
skip, referring the reader to \cite[Definition 1.5.8]{leinster}. (Note: what
we will be using is called ``weak functors'' in \cite{leinster}; compare with
...
\begin{example}\label{x:BC}
  ...
  \calB\calD$, see \cite[Example 1.5.9]{leinster}.
\end{example}

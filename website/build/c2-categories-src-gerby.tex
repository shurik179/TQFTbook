...
referring the reader to the books \cite{mac-lane} and \cite{etingof-fusion}
for details.
...
e.g., \cite[Lemma 1.1.12]{bakalov-kirillov}.
...
\begin{definition}\label{d:abelian}\index{abelian category}
  ...
  usual properties (see \cite[Section~1.3]{etingof-fusion} for details).
\end{definition}
...
\cite[Chapter 2]{etingof-fusion} and \cite[Section 1.2]{leinster} for a more
in-depth discussion.
...
\begin{remark}\label{r:lax}
  ...
  respectively; see \cite[Definition 1.2.10]{leinster}.
\end{remark}
...
\begin{exercise}\label{ec:twisted-group-cat}
  ...
  $\be\colon G\times G\to \kk^\times$ (see \cite[Section
  2.6]{etingof-fusion}).
\end{exercise}

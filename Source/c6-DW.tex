...
\ocite{baez-dolan-finite-sets}. In particular, we can count how many finite sets
there are --- try doing this yourself!

See also the blog post \ocite{baez-counting} by John Baez.


Similar ideas can also be used, e.g., to define the Euler characteristic of
an orbifold (see \ocite{caramello}*{Section 2.4}). Note: there are several
